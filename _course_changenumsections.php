...
// ADDED LINE ABOVE: For function format_aimtopicb_course_create_section .
...
if (isset($insertparentid)) {
    ...
    $insertsection->level = $insertlevel ?? FORMAT_AIMTOPICB_SECTION_LEVEL_TOPIC;
}
// END ADDED.
...
if (false) {                                                                    // CHANGED: Don't use numsections.
    ...
    for ($i = 0; $i < max($numsections, 1); $i ++) {
        $sections[] = format_aimtopicb_course_create_section($course, $insertsection);
