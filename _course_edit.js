...
M.course.format.fmtBannerPreviewSlice = function() {
    ...
    var bannersliceDom = document.querySelector("body.format-aimtopicb div#page select#id_bannerslice");
    var bannerslice = bannersliceDom.options[bannersliceDom.selectedIndex].value;

    // Locate banner.
    var headerDom = document.querySelector("body.format-aimtopicb div#course-header, body.format-aimtopicb div#page-mast");
...
M.course.format.fmtBannerPreviewImage = function() {
    ...
    var imageFilemanagerDom = document.querySelector("body.format-aimtopicb div#page #id_descriptionhdr .filemanager");
