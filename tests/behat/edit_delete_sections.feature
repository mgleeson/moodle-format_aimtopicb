@format @format_aimtopicb
Feature: Sections can be edited and deleted in AIMtopicb format
  ...
  Scenario: View the default name of the general section in AIMtopicb format
    When I edit the section "0"
    Then the field "Custom" matches value "0"
    And the field "New value for Section name" matches value "General"

  Scenario: Edit the default name of the general section in AIMtopicb format
  ...
  Scenario: View the default name of the second section in AIMtopicb format
    When I edit the section "2"
    Then the field "Custom" matches value "0"
    And the field "New value for Section name" matches value "Section 2"

  Scenario: Edit section summary in AIMtopicb format
    When I edit the section "2" and I fill the form with:
      | Summary | Welcome to section 2 |
    Then I should see "Welcome to section 2" in the "Section 2" "section"

  Scenario: Edit section default name in AIMtopicb format
    When I edit the section "2" and I fill the form with:
      | Custom | 1                      |
  ...
  @javascript
  Scenario: Inline edit section name in AIMtopicb format
  ...
  Scenario: Deleting the last section in AIMtopicb format
  ...
  Scenario: Deleting the middle section in AIMtopicb format
    Given I should see "Section 5" in the "Section 5" "section"
  ...
  @javascript
  Scenario: Adding sections at the end of a AIMtopicb format
