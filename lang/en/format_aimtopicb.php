...
/**
 * Strings for component AIMtopicb course format.
 *
...
$string['pluginname'] = 'AIMtopic (SF Dashboard) format';
$string['section0name'] = 'General';
$string['page-course-view-aimtopicb'] = 'Any course main page in AIMtopicb format';
$string['page-course-view-aimtopicb-x'] = 'Any course page in AIMtopicb format';
$string['hidefromothers'] = 'Hide section';
$string['showfromothers'] = 'Show section';
$string['privacy:metadata'] = 'The AIMtopicb format plugin does not store any personal data.';
// END CHANGED.
