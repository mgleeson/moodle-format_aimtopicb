...
import Tab from 'format_aimtopicb/courseformat/contenttabs/tab';
 ...
 *
 * @module     format_aimtopicb/courseformat/contenttabs/tabtree
 * @class      format_aimtopicb/courseformat/contenttabs/tabtree
    ...
    async _fixOrder(container, neworder, selector, level, hassubtree) {
        ...
        for (const [index, itemid] of Object.entries(neworder)) {
            ...
            if (item === null) {
                ...
                let html = await Templates.render("format_aimtopicb/courseformat/contenttabs/tab", data);
