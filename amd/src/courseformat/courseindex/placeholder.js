 ...
 *
 * @module     format_aimtopicb/courseformat/courseindex/placeholder
 * @class      format_aimtopicb/courseformat/courseindex/placeholder
    ...
    async loadTemplateContent(state) {
        ...
        try {
            ...
            const {html, js} = await Templates.renderForPromise(
                'format_aimtopicb/courseformat/courseindex/courseindex', // CHANGED.
                data,
            );
