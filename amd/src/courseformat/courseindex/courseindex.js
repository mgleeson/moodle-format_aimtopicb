 ...
 *
 * @module     format_aimtopicb/courseformat/courseindex/courseindex
 * @class      format_aimtopicb/courseformat/courseindex/courseindex
...
export default class Component extends BaseComponent {
    ...
    async _createSection({state, element}) {
        ...
        const newcomponent = await this.renderComponent(fakeelement, 'format_aimtopicb/courseformat/courseindex/section', data);
        // CHANGED LINE ABOVE.
