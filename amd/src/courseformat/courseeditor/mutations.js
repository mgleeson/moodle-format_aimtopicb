 ...
 *
 * @module     format_aimtopicb/courseformat/courseeditor/mutations
...
class AIMtopicbMutations extends DefaultMutations {
...
export const init = () => {
    ...
    courseEditor.addMutations(new AIMtopicbMutations());
};
