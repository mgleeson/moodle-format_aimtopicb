...
namespace format_aimtopicb\output\courseformat\content;
...
class section extends section_base {
    ...
    protected function add_cm_data(\stdClass &$data, \renderer_base $output): bool {
        ...
        $pageid = ($section->levelsan < FORMAT_AIMTOPICB_SECTION_LEVEL_TOPIC) ? $section->id
            : $section->parentid;
    ...
    protected function add_format_data(\stdClass &$data, array $haspartials, \renderer_base $output): bool {
        ...
        if ($section->levelsan < FORMAT_AIMTOPICB_SECTION_LEVEL_TOPIC) {
            ...
            if (format_aimtopicb_duration_as_days($section->periodduration) === 0) {
