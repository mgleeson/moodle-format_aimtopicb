...
class summary extends summary_base {
     ...
     * Constructor.
     *
     * @param \format_aimtopicb $format the course format
     * @param \section_info $section the section info
     */
    public function __construct(\format_aimtopicb $format, \section_info $section) {
    ...
    public function format_summary_text(): string {
        ...
        if (isset($imageurl)) {
            ...
            $o .= \format_aimtopicb_image_attribution($imagename, $authorwithurl, $licencecode);
